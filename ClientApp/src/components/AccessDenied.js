...
export default function AccessDenied() {
    ...
    return (
        <div className="text-center bg-light" style={{"height":"100%"}}>
            ...
            <h6 className="text-danger">Seu usuário não possui permissão para acessar este recurso</h6>
            <p className="text-danger">Você será redirecionado em <span >{counter}</span> segundos...</p>
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="20em" height="20em" viewBox="0 0 1280.000000 1275.000000"
                preserveAspectRatio="xMidYMid meet">
                <metadata>
                    Created by potrace 1.15, written by Peter Selinger 2001-2017
        </metadata>
                <g transform="translate(0.000000,1275.000000) scale(0.100000,-0.100000)"
                    fill="#c71a1a" stroke="none">
