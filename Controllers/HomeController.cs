...
namespace PlataformaTccSuporte.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public readonly DirectoryInfo dir = new DirectoryInfo(@"C:\Users\Patrick\Desktop\PlataformaTccSuporte\PlataformaTccSuporte\wwwroot\ArquivosEnviados");
        private readonly IServicoEmail mailService;
        private readonly ITwilioService twilioService;
        private readonly UserManager<User> userManager;
        public HomeController(UserManager<User> userManager,ILogger<HomeController> logger, IHostingEnvironment _environment, IServicoEmail mailService, ITwilioService twilioService)
        {
            _logger = logger;
